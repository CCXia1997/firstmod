...
public class ItemLoader {
	public static Item[] items = {
			new ItemSword(EnumHelper.addToolMaterial("CHROME", 3, 1817, 2.0F, 8.0F, 15)).setUnlocalizedName("rubble").setRegistryName("rubble").setCreativeTab(CreativeTabsRedo.tabRedo),
